...
function SeekerController($scope, MainService, PDFService, blockUI, Upload, $q) {
    var vm = this;
    let pdf = 'img/Resume_June PDF.pdf';

    //let a = PDFService.readPDF();
    // let a = FileService.get('Resume_JunePDF.pdf');
    //let b = PDFService.readPDF('/pdf/Resume_June PDF.pdf');
